...
import com.usc.staybooking.model.StayAvailability;
import com.usc.staybooking.model.StayAvailabilityKey;
...
public interface StayAvailabilityRepository extends JpaRepository<StayAvailability, StayAvailabilityKey> {
    ...
    List<Long> findByDateBetweenInAndStateIsAvailable(List<Long> stayIds, LocalDate startDate, LocalDate endDate, long duration);
